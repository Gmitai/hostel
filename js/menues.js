...
const refreshBtn = document.getElementById('refreshBtn');
    ...
    function createNav() {
      TABLES.forEach(key => {
        ...
        btn.textContent = key === 'students' ? 'Донишҷӯён' : humanizeKey(key);
        btn.dataset.key = key;
    ...
    function humanizeKey(key){
      const map = {buildings:'Биноҳо', cities:'Шаҳр/Ноҳия', employees:'Кормандон', department:'Кафедраҳо', log_book:'Журнал', rooms:'Ҳучраҳо', students:'Донишҷӯён', users:'Истифодабарандагон'};
      return map[key]||key;
    }
